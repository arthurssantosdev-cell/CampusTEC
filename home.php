...
<body>
    ...
    <div class="search-container">
        <h1 id="buscar">Buscar vaga</h1>
        <form id="search-form" class="search-form" onsubmit="buscarVagas(event)">
            <input type="text" id="busca" name="busca" class="search-input" placeholder="Digite sua busca...">
            <button type="submit" class="search-button">Buscar</button>
        </form>
        <div id="resultado-busca" class="resultado-busca"></div>
        <div class="container">
            <div class="box">Conheça sobre o mercado de trabalho e suas oportunidades<img src="imagens/ds.png" id="ds">
            </div>
            <div class="box">Se conecte com pessoas e conquiste seu primeiro emprego ainda no Ensino Médio!<img
                    src="imagens/adm.jpg" id="adm"></div>
            <div class="box">Ambiente favorável para estudantes e alunos se formando no 3° ano<img
                    src="imagens/estudo.jpg" id="estudo"></div>
        </div>
    </div>
